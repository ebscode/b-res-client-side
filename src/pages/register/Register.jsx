        ...
        <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
          <form onSubmit={handleregister} className="w-full max-w-md">
            ...
            <div className="mt-6">
              ...
              <a onClick={handlegoogle} href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-gray-900 transition-colors duration-300 transform border rounded-lg dark:border-gray-900 dark:text-gray-900 hover:bg-gray-50 dark:hover:bg-gray-600">
